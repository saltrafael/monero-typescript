...
export { TaskLooper };
import ThreadPool from "./src/main/js/common/ThreadPool";
export { ThreadPool };
 ...
 */
export function connectToWalletRpc(...args) {
  return MoneroWalletRpc._connectToWalletRpc(args);
}
 ...
 */
export function createWalletFull(...args) {
  return MoneroWalletFull.createWallet(args);
}
 ...
 */
export function openWalletFull(...args) {
  return MoneroWalletFull.openWallet(args);
}
 ...
 */
export function createWalletKeys(...args) {
  return MoneroWalletKeys.createWallet(args);
}
